...
const AddEditPhaseStructureModal: React.FC<AddEditPhaseStructureModalProps> = ({ isOpen, onClose, onSave, existingStructure, academicStructure, teachers, currentTenantId }) => {
    
    const [formData, setFormData] = useState<Omit<PhaseStructure, 'id' | 'tenantId'>>({
        phase: '',
        phaseHeadId: '',
        grades: [],
        curriculumIds: [],
    ...
    useEffect(() => {
        if (existingStructure) {
            setFormData({
                ...
                curriculumIds: existingStructure.curriculumIds,
            });
        } else {
            setFormData({
                phase: '',
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        const finalStructure: PhaseStructure = {
            ...
            tenantId: existingStructure?.tenantId || currentTenantId,
            ...formData,
        };
