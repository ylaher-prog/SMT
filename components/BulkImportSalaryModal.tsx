            ...
            <div className="space-y-4">
                <div>
                    ...
                    <ul className="list-disc list-inside text-sm text-brand-text-light dark:text-gray-400 mt-2 bg-gray-50 dark:bg-slate-700/50 p-3 rounded-md">
                        <li>This process will **update** salary information for existing teachers matched by their `Employee Code`. It will not create new teachers.</li>
                         ...
                         <div className="max-h-60 overflow-y-auto border dark:border-slate-600 rounded-md">
                            <table className="min-w-full divide-y divide-gray-200 dark:divide-slate-600 text-sm">
                                <thead className="bg-gray-50 dark:bg-slate-700">
                                    <tr>
                                        <th className="px-4 py-2 text-left font-medium text-gray-500 dark:text-gray-300">Teacher to Update</th>
                                       ...
                                       <tr key={index} className={row.error ? 'bg-red-50 dark:bg-red-900/20' : ''}>
                                            ...
                                            <td className="px-4 py-2">
                                                {row.error 
                                                    ...
                                                    : <span className="text-green-600 dark:text-green-400 font-semibold">Ready to Update</span>
                                                }
                                            </td>
                                       </tr>
                                   ))}
                ...
                <div className="flex justify-end gap-4 pt-4">
                    ...
                    >
                        Update {parsedData.filter(d => !d.error).length} Records
                    </button>
                </div>
            </div>
        </Modal>
