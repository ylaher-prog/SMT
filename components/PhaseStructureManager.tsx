...
const PhaseStructureManager: React.FC<PhaseStructureManagerProps> = ({ phaseStructures, setPhaseStructures, academicStructure, teachers, currentTenantId }) => {
                            ...
                            <div key={ps.id} className="bg-gray-50 dark:bg-slate-800 border dark:border-slate-700 rounded-lg p-5 flex flex-col">
                                <div className="flex-grow">
                                    ...
                                    <div className="mt-4">
                                        ...
                                        <div className="flex flex-wrap gap-1.5">
                                            {ps.curriculumIds.map(cId => <span key={cId} className="px-2 py-0.5 text-xs bg-gray-200 dark:bg-slate-700 text-gray-800 dark:text-gray-300 rounded-full">{curriculumMap.get(cId) || 'Unknown'}</span>)}
                                        </div>
                                    </div>
                                </div>
                            </div>
