                    ...
                    <ReportSection title="Allocations">
                        {teacherAllocations.length > 0 ? (
                             <table className="w-full text-sm text-left">
                                ...
                                <tbody>{teacherAllocations.map(a => <tr key={a.id} className="border-b"><td className="p-2 font-semibold">{a.classGroup?.name}</td><td className="p-2">{a.subject?.name}</td><td className="p-2">{a.classGroup?.grade}</td><td className="p-2">{curriculumMap.get(a.classGroup?.curriculumId || '')}</td></tr>)}</tbody>
                            </table>
