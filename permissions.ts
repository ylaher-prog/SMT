...
export const PERMISSIONS_CONFIG: { category: string, permissions: {id: Permission, label: string}[] }[] = [
    ...
    },
    {
        category: 'Workflow',
        permissions: [
            { id: 'view:workflow', label: 'View Workflow Page' },
            { id: 'manage:workflow', label: 'Create, Edit & Delete Workflows' },
        ],
    },
    {
        category: 'Recruitment',
        permissions: [
            { id: 'view:recruitment', label: 'View Recruitment Page' },
            { id: 'manage:recruitment', label: 'Manage Vacancies & Applications' },
            { id: 'action:hire-candidate', label: 'Hire Candidate (creates teacher profile)' },
        ]
    },
    {
        category: 'Payroll',
    ...
    },
    {
    ...
    },
     {
        category: 'Assets',
        permissions: [
            { id: 'view:assets', label: 'View Assets Page' },
            { id: 'manage:assets', label: 'Manage Assets (Add, Edit, Assign)' },
        ],
    },
    {
        category: 'Analytics',
        permissions: [
            { id: 'view:analytics', label: 'View Analytics Page' },
        ],
    },
    {
        category: 'Settings',
